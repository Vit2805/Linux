...
void chat_func(int new_socket_fd){
    ...
    while(1){
        ...
        /*Hàm read sẽ block cho đến khi đọc dược dữ liệu*/
...
int main(int argc, char *argv[]){
    ...
    /*Nghe tối đa 5 kết nối tỏng hàng đợi*/
